...
const ROUTE_TO_HTML = {
  ...
  '/tribeca/': 'tribeca/index.html',
  '/upper-east-side/': 'upper-east-side/index.html',
  ...
  '/journal/manhattan-doorman-coi-guide/': 'journal/manhattan-doorman-coi-guide/index.html',
  '/journal/cocktail-catering-vs-mixology-atelier/': 'journal/cocktail-catering-vs-mixology-atelier/index.html',
  '/journal/hamptons-estate-cocktail-logistics/': 'journal/hamptons-estate-cocktail-logistics/index.html',
