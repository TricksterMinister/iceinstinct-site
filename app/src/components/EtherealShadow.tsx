...
/* EtherealShadow - soft animated haze background layer.
   Adapted for the Ice & Instinct Vite/React stack (no Tailwind, no shadcn):
   - imports from `motion/react` (the installed `motion` v11 package, framer-motion API)
   - demo <h1> removed: this is a pure background, content sits above it
   - reduced-motion aware: animation is disabled, leaving a static masked tint
   Pass `style` to position it (it merges last, overriding the fill defaults). */
