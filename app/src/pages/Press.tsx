...
const BIO_SHORT =
  'Teimuraz Benidze is the founder and Flavor Architect of Ice & Instinct, a private mixology studio serving the New York metropolitan area and New Jersey. The first certified sommelier in Georgia’s history, he brings two decades of wine and service to a single discipline: cocktails composed in the room, for the room.';

const BIO_LONG_PARAS = [
  'Teimuraz Benidze spent two decades in wine and service before founding Ice & Instinct in 2024. The first certified sommelier in Georgia’s history, he holds four credentials: a Certificat in Wine & Sommellerie from Chateau-Arnoux, France; Leading Qualified Sommelier with the Georgian Sommelier Association (ASI); a Diploma in Wines & Spirits from Enotria Wine World, Moscow; and French Wine Studies with O.N.I.VINS.',
