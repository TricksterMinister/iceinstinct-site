    ...
    <>
      ...
      <div className="closing-segment oma-close" id="final-cta">
        <section className="closing">
          <div className="section-bg-word top right" aria-hidden="true">MANHATTAN</div>
          <div className="closing-stage">
            <div className="closing-frame">
              ...
              <span className="closing-eyebrow">Ice &amp; Instinct / Manhattan</span>
              <h2 className="closing-title">
                The city below. <span className="it">The bar upstairs.</span>
              </h2>
              <p className="closing-lead">
                Tell us the date, the building, and the guest count.
                <br />
            ...
            <p className="closing-meta">
              ...
              <span>Manhattan &amp; the New York Metropolitan Area</span>
              <span>Est. 2024</span>
            </p>
          </div>
        </section>
