      ...
      <div className="va-overlay" aria-hidden="true" ref={overlayRef}>
        ...
        <div className="va-stage">
          ...
          <ul className="va-list" ref={listRef}>
            ...
            <li><a href="/events/" data-cursor="link"><i>02</i><b>Event Bartenders</b><em>The bench on call ($450 flat)</em></a></li>
            <li><a href="/offerings/" data-cursor="link"><i>03</i><b>Master Atelier</b><em>Four levels, one standard</em></a></li>
