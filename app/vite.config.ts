  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        newJersey: r('new-jersey/index.html'),
        manhattan: r('manhattan/index.html'),
        hamptons: r('hamptons/index.html'),
        westchesterGreenwich: r('westchester-greenwich/index.html'),
        journal: r('journal/index.html'),
        ...
        journalManhattanCoi: r('journal/manhattan-doorman-coi-guide/index.html'),
        journalCateringVsAtelier: r('journal/cocktail-catering-vs-mixology-atelier/index.html'),
        journalHamptonsLogistics: r('journal/hamptons-estate-cocktail-logistics/index.html'),
        tribeca: r('tribeca/index.html'),
        upperEastSide: r('upper-east-side/index.html'),
