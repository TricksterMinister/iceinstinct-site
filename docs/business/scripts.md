...
4 часа, классика по списку. $200 на руки, Zelle в тот же вечер. (цифра по тиру: B-bench $180-200, A-bench $200-240 за 4 часа; ниже $180 не предлагаем - это публичное обещание скамейке)
